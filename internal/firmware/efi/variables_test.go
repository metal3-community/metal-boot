...
func TestEfiVarInitialization(t *testing.T) {
	...
	testVar := efi.NewEfiVar("TestVar", efi.EfiGlobalVariableGUID, []byte{0x01, 0x02, 0x03, 0x04})
	
	assert.Equal(t, "TestVar", testVar.Name)
	assert.Equal(t, efi.EfiGlobalVariableGUID, testVar.GuidStr)
...
func TestEfiVarWithAttributes(t *testing.T) {
	...
	testVar := efi.NewEfiVarWithAttrs("TestVar", efi.EfiGlobalVariableGUID, []byte{0x01, 0x02, 0x03, 0x04}, attrs)
...
func TestEfiVarDefaultAttributes(t *testing.T) {
	...
	secureBootVar := efi.NewEfiVar("SecureBoot", efi.EfiGlobalVariableGUID, []byte{0x01})
	...
	customVar := efi.NewEfiVar("CustomVar", efi.EfiGlobalVariableGUID, []byte{0x01})
...
func TestEfiVarCopy(t *testing.T) {
	...
	original := efi.NewEfiVar("TestVar", efi.EfiGlobalVariableGUID, []byte{0x01, 0x02, 0x03, 0x04})
...
func TestEfiVarBootOrder(t *testing.T) {
	...
	// Create the variable
	bootOrderVar := efi.NewEfiVar("BootOrder", efi.EfiGlobalVariableGUID, bootOrderData)
...
func TestEfiVarBootEntry(t *testing.T) {
	...
	// Create the variable
	bootEntryVar := efi.NewEfiVar("Boot0001", efi.EfiGlobalVariableGUID, bootEntryData)
...
func TestEfiVarAttributes(t *testing.T) {
	...
	testVar := efi.NewEfiVarWithAttrs("TestVar", efi.EfiGlobalVariableGUID, []byte{0x01}, attrs)
...
func TestEfiVarSecurityAttributes(t *testing.T) {
	...
	secureVar := efi.NewEfiVarWithAttrs("SecureVar", efi.EfiGlobalVariableGUID, []byte{0x01}, attrs)
...
func TestEfiVarData(t *testing.T) {
	...
	testVar := efi.NewEfiVar("TestVar", efi.EfiGlobalVariableGUID, initialData)
...
func TestEfiVarGuids(t *testing.T) {
	...
	testVar := efi.NewEfiVar("TestVar", efi.EfiGlobalVariableGUID, []byte{0x01})
	assert.Equal(t, efi.EfiGlobalVariableGUID, testVar.GuidStr)
