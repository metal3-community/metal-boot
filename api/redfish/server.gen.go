...
func RegisterHandlersWithOptions(router gin.IRouter, si ServerInterface, options GinServerOptions) {
	...
	router.POST(options.BaseURL+"/redfish/v1/Systems/:systemId/Actions/ComputerSystem.Reset", wrapper.ResetSystem)
	router.DELETE(options.BaseURL+"/redfish/v1/Systems/:systemId/Storage/Volumes/:StorageId", wrapper.DeleteVirtualdisk)
	router.GET(options.BaseURL+"/redfish/v1/Systems/:systemId/Storage/:StorageControllerId/Volumes", wrapper.GetVolumes)
	router.POST(options.BaseURL+"/redfish/v1/Systems/:systemId/Storage/:StorageControllerId/Volumes", wrapper.CreateVirtualDisk)
